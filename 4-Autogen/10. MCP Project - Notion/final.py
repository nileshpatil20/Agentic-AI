...
# notion_secret removed; set NOTION_API_KEY in .env
...
if not NOTION_API_KEY:
    raise RuntimeError(
        "Missing NOTION_API_KEY (or NOTION_API_TOKEN). Set it in your environment or .env file."
    )
port = 7001
...
if __name__=='__main__':
    ...
    if not NGROK_AUTH_TOKEN:
        raise RuntimeError("Missing NGROK_AUTH_TOKEN. Set it in your environment or .env file.")
